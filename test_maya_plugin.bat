...
@REM Set Maya location for runtime libraries
...
set PATH=%MAYA_LOCATION%\bin;%MAYA_LOCATION%\lib;%PATH%


@REM run a2x_local tests with dependencies in the path
cd %BASE_DIR%
call "%BASE_DIR%_build\windows-x86_64\release\bin\tests_maya_plugin.exe" %*
