...
extern EmotionParametersDefaultTypeInternal _EmotionParameters_default_instance_;
class EmotionParameters_BeginningEmotionEntry_DoNotUse;
struct EmotionParameters_BeginningEmotionEntry_DoNotUseDefaultTypeInternal;
extern EmotionParameters_BeginningEmotionEntry_DoNotUseDefaultTypeInternal _EmotionParameters_BeginningEmotionEntry_DoNotUse_default_instance_;
...
class EmotionParameters_BeginningEmotionEntry_DoNotUse final
    : public ::google::protobuf::internal::MapEntry<
          EmotionParameters_BeginningEmotionEntry_DoNotUse, std::string, float,
          ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
          ::google::protobuf::internal::WireFormatLite::TYPE_FLOAT> {
 public:
  using SuperType = ::google::protobuf::internal::MapEntry<
      ...
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_FLOAT>;
  EmotionParameters_BeginningEmotionEntry_DoNotUse();
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR EmotionParameters_BeginningEmotionEntry_DoNotUse(
      ::google::protobuf::internal::ConstantInitialized);
  explicit EmotionParameters_BeginningEmotionEntry_DoNotUse(::google::protobuf::Arena* arena);
  static const EmotionParameters_BeginningEmotionEntry_DoNotUse* internal_default_instance() {
    return reinterpret_cast<const EmotionParameters_BeginningEmotionEntry_DoNotUse*>(
        &_EmotionParameters_BeginningEmotionEntry_DoNotUse_default_instance_);
  }
  static bool ValidateKey(std::string* s) {
    return ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(s->data(), static_cast<int>(s->size()), ::google::protobuf::internal::WireFormatLite::PARSE, "nvidia_ace.a2f.v1.EmotionParameters.BeginningEmotionEntry.key");
 }
  static bool ValidateValue(void*) { return true; }
  ::google::protobuf::Metadata GetMetadata() const final;
  friend struct ::TableStruct_nvidia_5face_2ea2f_2ev1_2eproto;
...
class EmotionParameters final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:nvidia_ace.a2f.v1.EmotionParameters) */ {
 public:
  inline EmotionParameters() : EmotionParameters(nullptr) {}
  ~EmotionParameters() override;
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR EmotionParameters(
      ::google::protobuf::internal::ConstantInitialized);

  inline EmotionParameters(const EmotionParameters& from) : EmotionParameters(nullptr, from) {}
  inline EmotionParameters(EmotionParameters&& from) noexcept
      : EmotionParameters(nullptr, std::move(from)) {}
  inline EmotionParameters& operator=(const EmotionParameters& from) {
    CopyFrom(from);
    return *this;
  }
  inline EmotionParameters& operator=(EmotionParameters&& from) noexcept {
    if (this == &from) return *this;
    if (GetArena() == from.GetArena()
#ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetArena() != nullptr
  ...
  static const EmotionParameters& default_instance() {
    return *internal_default_instance();
  }
  static inline const EmotionParameters* internal_default_instance() {
    return reinterpret_cast<const EmotionParameters*>(
        &_EmotionParameters_default_instance_);
  }
  static constexpr int kIndexInFileMessages = 11;
  friend void swap(EmotionParameters& a, EmotionParameters& b) { a.Swap(&b); }
  inline void Swap(EmotionParameters* other) {
    if (other == this) return;
#ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetArena() != nullptr && GetArena() == other->GetArena()) {
#else   // PROTOBUF_FORCE_COPY_IN_SWAP
  ...
  void UnsafeArenaSwap(EmotionParameters* other) {
    if (other == this) return;
    ABSL_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  EmotionParameters* New(::google::protobuf::Arena* arena = nullptr) const final {
    return ::google::protobuf::Message::DefaultConstruct<EmotionParameters>(arena);
  }
  using ::google::protobuf::Message::CopyFrom;
  void CopyFrom(const EmotionParameters& from);
  using ::google::protobuf::Message::MergeFrom;
  void MergeFrom(const EmotionParameters& from) { EmotionParameters::MergeImpl(*this, from); }
  ...
  void SharedCtor(::google::protobuf::Arena* arena);
  void SharedDtor();
  void InternalSwap(EmotionParameters* other);
 private:
  friend class ::google::protobuf::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() { return "nvidia_ace.a2f.v1.EmotionParameters"; }

 protected:
  explicit EmotionParameters(::google::protobuf::Arena* arena);
  EmotionParameters(::google::protobuf::Arena* arena, const EmotionParameters& from);
  EmotionParameters(::google::protobuf::Arena* arena, EmotionParameters&& from) noexcept
      : EmotionParameters(arena) {
    *this = ::std::move(from);
  }
  const ::google::protobuf::MessageLite::ClassData* GetClassData()
      const final;
 ...
 public:
  ...
  // accessors -------------------------------------------------------
  enum : int {
    kBeginningEmotionFieldNumber = 2,
    kLiveTransitionTimeFieldNumber = 1,
  };
  // map<string, float> beginning_emotion = 2;
  int beginning_emotion_size() const;
  private:
  int _internal_beginning_emotion_size() const;

  public:
  void clear_beginning_emotion() ;
  const ::google::protobuf::Map<std::string, float>& beginning_emotion() const;
  ::google::protobuf::Map<std::string, float>* mutable_beginning_emotion();

  private:
  const ::google::protobuf::Map<std::string, float>& _internal_beginning_emotion() const;
  ::google::protobuf::Map<std::string, float>* _internal_mutable_beginning_emotion();

  public:
  // optional float live_transition_time = 1;
  bool has_live_transition_time() const;
  void clear_live_transition_time() ;
  float live_transition_time() const;
  void set_live_transition_time(float value);

  private:
  float _internal_live_transition_time() const;
  void _internal_set_live_transition_time(float value);

  public:
  // @@protoc_insertion_point(class_scope:nvidia_ace.a2f.v1.EmotionParameters)
 private:
  class _Internal;
  friend class ::google::protobuf::internal::TcParser;
  static const ::google::protobuf::internal::TcParseTable<
  ...
  struct Impl_ {
    ...
    ::google::protobuf::internal::HasBits<1> _has_bits_;
    mutable ::google::protobuf::internal::CachedSize _cached_size_;
    ::google::protobuf::internal::MapField<EmotionParameters_BeginningEmotionEntry_DoNotUse, std::string, float,
                      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
                      ::google::protobuf::internal::WireFormatLite::TYPE_FLOAT>
        beginning_emotion_;
    float live_transition_time_;
    PROTOBUF_TSAN_DECLARE_MEMBER
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_nvidia_5face_2ea2f_2ev1_2eproto;
...
/* @@protoc_insertion_point(class_definition:nvidia_ace.a2f.v1.BlendShapeParameters) */ {
 ...
 public:
  ...
  enum : int {
    ...
    kEnableClampingBsWeightFieldNumber = 3,
  };
  ...
  bool has_enable_clamping_bs_weight() const;
  void clear_enable_clamping_bs_weight() ;
  bool enable_clamping_bs_weight() const;
  void set_enable_clamping_bs_weight(bool value);

  private:
  bool _internal_enable_clamping_bs_weight() const;
  void _internal_set_enable_clamping_bs_weight(bool value);
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::google::protobuf::internal::MapField<BlendShapeParameters_BsWeightOffsetsEntry_DoNotUse, std::string, float,
                      ...
                      ::google::protobuf::internal::WireFormatLite::TYPE_FLOAT>
        bs_weight_offsets_;
    bool enable_clamping_bs_weight_;
    PROTOBUF_TSAN_DECLARE_MEMBER
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_nvidia_5face_2ea2f_2ev1_2eproto;
...
/* @@protoc_insertion_point(class_definition:nvidia_ace.a2f.v1.AudioStreamHeader) */ {
 ...
 public:
  ...
  bool has_emotion_params() const;
  void clear_emotion_params() ;
  const ::nvidia_ace::a2f::v1::EmotionParameters& emotion_params() const;
  PROTOBUF_NODISCARD ::nvidia_ace::a2f::v1::EmotionParameters* release_emotion_params();
  ::nvidia_ace::a2f::v1::EmotionParameters* mutable_emotion_params();
  void set_allocated_emotion_params(::nvidia_ace::a2f::v1::EmotionParameters* value);
  void unsafe_arena_set_allocated_emotion_params(::nvidia_ace::a2f::v1::EmotionParameters* value);
  ::nvidia_ace::a2f::v1::EmotionParameters* unsafe_arena_release_emotion_params();

  private:
  const ::nvidia_ace::a2f::v1::EmotionParameters& _internal_emotion_params() const;
  ::nvidia_ace::a2f::v1::EmotionParameters* _internal_mutable_emotion_params();
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::nvidia_ace::a2f::v1::EmotionParameters* emotion_params_;
    PROTOBUF_TSAN_DECLARE_MEMBER
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_nvidia_5face_2ea2f_2ev1_2eproto;
...
// .nvidia_ace.a2f.v1.EmotionParameters emotion_params = 6;
inline bool AudioStreamHeader::has_emotion_params() const {
  bool value = (_impl_._has_bits_[0] & 0x00000020u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.emotion_params_ != nullptr);
  return value;
}
inline void AudioStreamHeader::clear_emotion_params() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (_impl_.emotion_params_ != nullptr) _impl_.emotion_params_->Clear();
  _impl_._has_bits_[0] &= ~0x00000020u;
}
inline const ::nvidia_ace::a2f::v1::EmotionParameters& AudioStreamHeader::_internal_emotion_params() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  const ::nvidia_ace::a2f::v1::EmotionParameters* p = _impl_.emotion_params_;
  return p != nullptr ? *p : reinterpret_cast<const ::nvidia_ace::a2f::v1::EmotionParameters&>(::nvidia_ace::a2f::v1::_EmotionParameters_default_instance_);
}
inline const ::nvidia_ace::a2f::v1::EmotionParameters& AudioStreamHeader::emotion_params() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:nvidia_ace.a2f.v1.AudioStreamHeader.emotion_params)
  return _internal_emotion_params();
}
inline void AudioStreamHeader::unsafe_arena_set_allocated_emotion_params(::nvidia_ace::a2f::v1::EmotionParameters* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (GetArena() == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.emotion_params_);
  }
  _impl_.emotion_params_ = reinterpret_cast<::nvidia_ace::a2f::v1::EmotionParameters*>(value);
  if (value != nullptr) {
    _impl_._has_bits_[0] |= 0x00000020u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000020u;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:nvidia_ace.a2f.v1.AudioStreamHeader.emotion_params)
}
inline ::nvidia_ace::a2f::v1::EmotionParameters* AudioStreamHeader::release_emotion_params() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);

  _impl_._has_bits_[0] &= ~0x00000020u;
  ::nvidia_ace::a2f::v1::EmotionParameters* released = _impl_.emotion_params_;
  _impl_.emotion_params_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old = reinterpret_cast<::google::protobuf::MessageLite*>(released);
  released = ::google::protobuf::internal::DuplicateIfNonNull(released);
  if (GetArena() == nullptr) {
...
inline ::nvidia_ace::a2f::v1::EmotionParameters* AudioStreamHeader::unsafe_arena_release_emotion_params() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:nvidia_ace.a2f.v1.AudioStreamHeader.emotion_params)

  _impl_._has_bits_[0] &= ~0x00000020u;
  ::nvidia_ace::a2f::v1::EmotionParameters* temp = _impl_.emotion_params_;
  _impl_.emotion_params_ = nullptr;
  return temp;
}
inline ::nvidia_ace::a2f::v1::EmotionParameters* AudioStreamHeader::_internal_mutable_emotion_params() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (_impl_.emotion_params_ == nullptr) {
    auto* p = ::google::protobuf::Message::DefaultConstruct<::nvidia_ace::a2f::v1::EmotionParameters>(GetArena());
    _impl_.emotion_params_ = reinterpret_cast<::nvidia_ace::a2f::v1::EmotionParameters*>(p);
  }
  return _impl_.emotion_params_;
}
inline ::nvidia_ace::a2f::v1::EmotionParameters* AudioStreamHeader::mutable_emotion_params() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  _impl_._has_bits_[0] |= 0x00000020u;
  ::nvidia_ace::a2f::v1::EmotionParameters* _msg = _internal_mutable_emotion_params();
  // @@protoc_insertion_point(field_mutable:nvidia_ace.a2f.v1.AudioStreamHeader.emotion_params)
  return _msg;
}
inline void AudioStreamHeader::set_allocated_emotion_params(::nvidia_ace::a2f::v1::EmotionParameters* value) {
  ::google::protobuf::Arena* message_arena = GetArena();
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (message_arena == nullptr) {
  ...
  _impl_.emotion_params_ = reinterpret_cast<::nvidia_ace::a2f::v1::EmotionParameters*>(value);
  // @@protoc_insertion_point(field_set_allocated:nvidia_ace.a2f.v1.AudioStreamHeader.emotion_params)
}
...
// optional bool enable_clamping_bs_weight = 3;
inline bool BlendShapeParameters::has_enable_clamping_bs_weight() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline void BlendShapeParameters::clear_enable_clamping_bs_weight() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_.enable_clamping_bs_weight_ = false;
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline bool BlendShapeParameters::enable_clamping_bs_weight() const {
  // @@protoc_insertion_point(field_get:nvidia_ace.a2f.v1.BlendShapeParameters.enable_clamping_bs_weight)
  return _internal_enable_clamping_bs_weight();
}
inline void BlendShapeParameters::set_enable_clamping_bs_weight(bool value) {
  _internal_set_enable_clamping_bs_weight(value);
  _impl_._has_bits_[0] |= 0x00000001u;
  // @@protoc_insertion_point(field_set:nvidia_ace.a2f.v1.BlendShapeParameters.enable_clamping_bs_weight)
}
inline bool BlendShapeParameters::_internal_enable_clamping_bs_weight() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return _impl_.enable_clamping_bs_weight_;
}
inline void BlendShapeParameters::_internal_set_enable_clamping_bs_weight(bool value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_.enable_clamping_bs_weight_ = value;
}
...
// optional float live_transition_time = 1;
inline bool EmotionParameters::has_live_transition_time() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline void EmotionParameters::clear_live_transition_time() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_.live_transition_time_ = 0;
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline float EmotionParameters::live_transition_time() const {
  // @@protoc_insertion_point(field_get:nvidia_ace.a2f.v1.EmotionParameters.live_transition_time)
  return _internal_live_transition_time();
}
inline void EmotionParameters::set_live_transition_time(float value) {
  _internal_set_live_transition_time(value);
  _impl_._has_bits_[0] |= 0x00000001u;
  // @@protoc_insertion_point(field_set:nvidia_ace.a2f.v1.EmotionParameters.live_transition_time)
}
inline float EmotionParameters::_internal_live_transition_time() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return _impl_.live_transition_time_;
}
inline void EmotionParameters::_internal_set_live_transition_time(float value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_.live_transition_time_ = value;
}

// map<string, float> beginning_emotion = 2;
inline int EmotionParameters::_internal_beginning_emotion_size() const {
  return _internal_beginning_emotion().size();
}
inline int EmotionParameters::beginning_emotion_size() const {
  return _internal_beginning_emotion_size();
}
inline void EmotionParameters::clear_beginning_emotion() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_.beginning_emotion_.Clear();
}
inline const ::google::protobuf::Map<std::string, float>& EmotionParameters::_internal_beginning_emotion() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return _impl_.beginning_emotion_.GetMap();
}
inline const ::google::protobuf::Map<std::string, float>& EmotionParameters::beginning_emotion() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_map:nvidia_ace.a2f.v1.EmotionParameters.beginning_emotion)
  return _internal_beginning_emotion();
}
inline ::google::protobuf::Map<std::string, float>* EmotionParameters::_internal_mutable_beginning_emotion() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  return _impl_.beginning_emotion_.MutableMap();
}
inline ::google::protobuf::Map<std::string, float>* EmotionParameters::mutable_beginning_emotion() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_mutable_map:nvidia_ace.a2f.v1.EmotionParameters.beginning_emotion)
  return _internal_mutable_beginning_emotion();
}
